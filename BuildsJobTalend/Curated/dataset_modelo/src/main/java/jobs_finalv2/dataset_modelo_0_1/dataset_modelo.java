...
package jobs_finalv2.dataset_modelo_0_1;
...
/**
 * Job: dataset_modelo Purpose: aaa<br>
 * Description: avv <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class dataset_modelo implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "dataset_modelo";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				dataset_modelo.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(dataset_modelo.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
    final static byte[] commonByteArrayLock_JOBS_FINALV2_dataset_modelo = new byte[0];
    static byte[] commonByteArray_JOBS_FINALV2_dataset_modelo = new byte[0];
	...
	public void copyDataTo(out1Struct other) {
		...
		other.SalesOrderID = this.SalesOrderID;
	            ...
	            other.ShipStateProvince = this.ShipStateProvince;
	            other.ShipCountryRegion = this.ShipCountryRegion;
	            other.ShipPostalCode = this.ShipPostalCode;
	            other.BillCity = this.BillCity;
	            other.BillStateProvince = this.BillStateProvince;
	            other.BillCountryRegion = this.BillCountryRegion;
	            other.BillPostalCode = this.BillPostalCode;
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_JOBS_FINALV2_dataset_modelo.length) {
				if(length < 1024 && commonByteArray_JOBS_FINALV2_dataset_modelo.length == 0) {
   					commonByteArray_JOBS_FINALV2_dataset_modelo = new byte[1024];
				} else {
   					commonByteArray_JOBS_FINALV2_dataset_modelo = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_JOBS_FINALV2_dataset_modelo, 0, length);
			strReturn = new String(commonByteArray_JOBS_FINALV2_dataset_modelo, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_JOBS_FINALV2_dataset_modelo) {
            ...
            csvSettings_tFileOutputDelimited_1.setEscapeAndTextEnclosure("\"","\"");
                    ...
                    if(!csvSettings_tFileOutputDelimited_1.isUseCRLFRecordDelimiter() && csvSettings_tFileOutputDelimited_1.getRowDelim()!='\r' && csvSettings_tFileOutputDelimited_1.getRowDelim()!='\n') {
                        ...
                        if(filetFileOutputDelimited_1.length()==0){
                                    ...
                                    headColutFileOutputDelimited_1[7]="CustomerID";
                                    headColutFileOutputDelimited_1[8]="ShipCity";
                                    headColutFileOutputDelimited_1[9]="ShipStateProvince";
                                    headColutFileOutputDelimited_1[10]="ShipCountryRegion";
                                    headColutFileOutputDelimited_1[11]="ShipPostalCode";
                                    headColutFileOutputDelimited_1[12]="BillCity";
                                    headColutFileOutputDelimited_1[13]="BillStateProvince";
                                    headColutFileOutputDelimited_1[14]="BillCountryRegion";
                                    headColutFileOutputDelimited_1[15]="BillPostalCode";
                                    headColutFileOutputDelimited_1[16]="ShipMethod";
                                    headColutFileOutputDelimited_1[17]="CreditCardApprovalCode";
                                    headColutFileOutputDelimited_1[18]="SubTotal";
                                    headColutFileOutputDelimited_1[19]="TaxAmt";
                                    headColutFileOutputDelimited_1[20]="Freight";
                                    headColutFileOutputDelimited_1[21]="TotalDue";
                                    headColutFileOutputDelimited_1[22]="OrderQty";
                                    headColutFileOutputDelimited_1[23]="UnitPrice";
                                    headColutFileOutputDelimited_1[24]="UnitPriceDiscount";
                                    headColutFileOutputDelimited_1[25]="LineTotal";
                                    headColutFileOutputDelimited_1[26]="CompanyName";
                                    headColutFileOutputDelimited_1[27]="SalesPerson";
                                    headColutFileOutputDelimited_1[28]="ProductNumber";
                                    headColutFileOutputDelimited_1[29]="ProductName";
                                    headColutFileOutputDelimited_1[30]="Color";
                                    headColutFileOutputDelimited_1[31]="StandardCost";
                                    headColutFileOutputDelimited_1[32]="ListPrice";
                                    headColutFileOutputDelimited_1[33]="Size";
                                    headColutFileOutputDelimited_1[34]="Weight";
                                    headColutFileOutputDelimited_1[35]="SellStartDate";
                                    headColutFileOutputDelimited_1[36]="SellEndDate";
                                    headColutFileOutputDelimited_1[37]="DiscontinuedDate";
                                    headColutFileOutputDelimited_1[38]="ProductCategoryName";
                                    headColutFileOutputDelimited_1[39]="ProductModelName";
...
out1_tmp.ShipCity = row4.City ;
out1_tmp.ShipStateProvince = row4.StateProvince ;
out1_tmp.ShipCountryRegion = row4.CountryRegion ;
out1_tmp.ShipPostalCode = row4.PostalCode ;
out1_tmp.BillCity = row8.City ;
out1_tmp.BillStateProvince = row8.StateProvince ;
out1_tmp.BillCountryRegion = row8.CountryRegion ;
out1_tmp.BillPostalCode = row8.PostalCode ;
	...
	currentComponent="tFileOutputDelimited_1";
					...
					if(execStat){
                        ...
                        String[] rowtFileOutputDelimited_1=new String[40];
                            ...
                            rowtFileOutputDelimited_1[7]=out1.CustomerID == null ? null : String.valueOf(out1.CustomerID);
                            rowtFileOutputDelimited_1[8]=out1.ShipCity == null ? null : out1.ShipCity;
                            rowtFileOutputDelimited_1[9]=out1.ShipStateProvince == null ? null : out1.ShipStateProvince;
                            rowtFileOutputDelimited_1[10]=out1.ShipCountryRegion == null ? null : out1.ShipCountryRegion;
                            rowtFileOutputDelimited_1[11]=out1.ShipPostalCode == null ? null : out1.ShipPostalCode;
                            rowtFileOutputDelimited_1[12]=out1.BillCity == null ? null : out1.BillCity;
                            rowtFileOutputDelimited_1[13]=out1.BillStateProvince == null ? null : out1.BillStateProvince;
                            rowtFileOutputDelimited_1[14]=out1.BillCountryRegion == null ? null : out1.BillCountryRegion;
                            rowtFileOutputDelimited_1[15]=out1.BillPostalCode == null ? null : out1.BillPostalCode;
                            rowtFileOutputDelimited_1[16]=out1.ShipMethod == null ? null : out1.ShipMethod;
                            rowtFileOutputDelimited_1[17]=out1.CreditCardApprovalCode == null ? null : out1.CreditCardApprovalCode;
                            rowtFileOutputDelimited_1[18]=out1.SubTotal == null ? null : String.valueOf(out1.SubTotal);
                            rowtFileOutputDelimited_1[19]=out1.TaxAmt == null ? null : String.valueOf(out1.TaxAmt);
                            rowtFileOutputDelimited_1[20]=out1.Freight == null ? null : String.valueOf(out1.Freight);
                            rowtFileOutputDelimited_1[21]=out1.TotalDue == null ? null : String.valueOf(out1.TotalDue);
                            rowtFileOutputDelimited_1[22]=out1.OrderQty == null ? null : String.valueOf(out1.OrderQty);
                            rowtFileOutputDelimited_1[23]=out1.UnitPrice == null ? null : String.valueOf(out1.UnitPrice);
                            rowtFileOutputDelimited_1[24]=out1.UnitPriceDiscount == null ? null : String.valueOf(out1.UnitPriceDiscount);
                            rowtFileOutputDelimited_1[25]=out1.LineTotal == null ? null : String.valueOf(out1.LineTotal);
                            rowtFileOutputDelimited_1[26]=out1.CompanyName == null ? null : out1.CompanyName;
                            rowtFileOutputDelimited_1[27]=out1.SalesPerson == null ? null : out1.SalesPerson;
                            rowtFileOutputDelimited_1[28]=out1.ProductNumber == null ? null : out1.ProductNumber;
                            rowtFileOutputDelimited_1[29]=out1.ProductName == null ? null : out1.ProductName;
                            rowtFileOutputDelimited_1[30]=out1.Color == null ? null : out1.Color;
                            rowtFileOutputDelimited_1[31]=out1.StandardCost == null ? null : String.valueOf(out1.StandardCost);
                            rowtFileOutputDelimited_1[32]=out1.ListPrice == null ? null : String.valueOf(out1.ListPrice);
                            rowtFileOutputDelimited_1[33]=out1.Size == null ? null : out1.Size;
                            rowtFileOutputDelimited_1[34]=out1.Weight == null ? null : out1.Weight;
                            rowtFileOutputDelimited_1[35]=out1.SellStartDate == null ? null : out1.SellStartDate;
                            rowtFileOutputDelimited_1[36]=out1.SellEndDate == null ? null : out1.SellEndDate;
                            rowtFileOutputDelimited_1[37]=out1.DiscontinuedDate == null ? null : out1.DiscontinuedDate;
                            rowtFileOutputDelimited_1[38]=out1.ProductCategoryName == null ? null : out1.ProductCategoryName;
                            rowtFileOutputDelimited_1[39]=out1.ProductModelName == null ? null : out1.ProductModelName;
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row2";
		...
		int tos_count_tAdvancedHash_row2 = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(row1,row2,row3,row4,row5,row6,row7,row8) outputs:(out1)
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_5 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_5 = /** Start field tFileInputDelimited_5:FILENAME */"C:/Users/alons/Documents/MBA FIAP/DATAOPS/projeto_dataops/harmonized/FH_product.csv"/** End field tFileInputDelimited_5:FILENAME */;		
	                ...
	                int columnIndexWithD_tFileInputDelimited_5 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_5 < rowtFileInputDelimited_5.length){
									...
									if(rowtFileInputDelimited_5[columnIndexWithD_tFileInputDelimited_5].length() > 0) {
										...
										row5.ProductID = ParserUtils.parseTo_Integer(rowtFileInputDelimited_5[columnIndexWithD_tFileInputDelimited_5]);
											...
											rowstate_tFileInputDelimited_5.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"ProductID", "row5", rowtFileInputDelimited_5[columnIndexWithD_tFileInputDelimited_5], ex_tFileInputDelimited_5), ex_tFileInputDelimited_5));
										}
    								}else{
						...
						if(columnIndexWithD_tFileInputDelimited_5 < rowtFileInputDelimited_5.length){
									...
									row5.ProductNumber = rowtFileInputDelimited_5[columnIndexWithD_tFileInputDelimited_5];
						...
						if(columnIndexWithD_tFileInputDelimited_5 < rowtFileInputDelimited_5.length){
									...
									row5.Name = rowtFileInputDelimited_5[columnIndexWithD_tFileInputDelimited_5];
						...
						if(columnIndexWithD_tFileInputDelimited_5 < rowtFileInputDelimited_5.length){
									...
									row5.Color = rowtFileInputDelimited_5[columnIndexWithD_tFileInputDelimited_5];
						...
						if(columnIndexWithD_tFileInputDelimited_5 < rowtFileInputDelimited_5.length){
									...
									if(rowtFileInputDelimited_5[columnIndexWithD_tFileInputDelimited_5].length() > 0) {
										...
										row5.StandardCost = ParserUtils.parseTo_Float(rowtFileInputDelimited_5[columnIndexWithD_tFileInputDelimited_5]);
									
									
										} catch(java.lang.Exception ex_tFileInputDelimited_5) {
											rowstate_tFileInputDelimited_5.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"StandardCost", "row5", rowtFileInputDelimited_5[columnIndexWithD_tFileInputDelimited_5], ex_tFileInputDelimited_5), ex_tFileInputDelimited_5));
										}
    								}else{
						...
						if(columnIndexWithD_tFileInputDelimited_5 < rowtFileInputDelimited_5.length){
									...
									if(rowtFileInputDelimited_5[columnIndexWithD_tFileInputDelimited_5].length() > 0) {
										...
										row5.ListPrice = ParserUtils.parseTo_Float(rowtFileInputDelimited_5[columnIndexWithD_tFileInputDelimited_5]);
									
									
										} catch(java.lang.Exception ex_tFileInputDelimited_5) {
											rowstate_tFileInputDelimited_5.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"ListPrice", "row5", rowtFileInputDelimited_5[columnIndexWithD_tFileInputDelimited_5], ex_tFileInputDelimited_5), ex_tFileInputDelimited_5));
										}
    								}else{
						...
						if(columnIndexWithD_tFileInputDelimited_5 < rowtFileInputDelimited_5.length){
									...
									row5.Size = rowtFileInputDelimited_5[columnIndexWithD_tFileInputDelimited_5];
						...
						if(columnIndexWithD_tFileInputDelimited_5 < rowtFileInputDelimited_5.length){
									...
									row5.Weight = rowtFileInputDelimited_5[columnIndexWithD_tFileInputDelimited_5];
						...
						if(columnIndexWithD_tFileInputDelimited_5 < rowtFileInputDelimited_5.length){
									...
									if(rowtFileInputDelimited_5[columnIndexWithD_tFileInputDelimited_5].length() > 0) {
										...
										row5.ProductCategoryID = ParserUtils.parseTo_Integer(rowtFileInputDelimited_5[columnIndexWithD_tFileInputDelimited_5]);
									
									
										} catch(java.lang.Exception ex_tFileInputDelimited_5) {
											rowstate_tFileInputDelimited_5.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"ProductCategoryID", "row5", rowtFileInputDelimited_5[columnIndexWithD_tFileInputDelimited_5], ex_tFileInputDelimited_5), ex_tFileInputDelimited_5));
										}
    								}else{
						...
						if(columnIndexWithD_tFileInputDelimited_5 < rowtFileInputDelimited_5.length){
									...
									if(rowtFileInputDelimited_5[columnIndexWithD_tFileInputDelimited_5].length() > 0) {
										...
										row5.ProductModelID = ParserUtils.parseTo_Integer(rowtFileInputDelimited_5[columnIndexWithD_tFileInputDelimited_5]);
									
									
										} catch(java.lang.Exception ex_tFileInputDelimited_5) {
											rowstate_tFileInputDelimited_5.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"ProductModelID", "row5", rowtFileInputDelimited_5[columnIndexWithD_tFileInputDelimited_5], ex_tFileInputDelimited_5), ex_tFileInputDelimited_5));
										}
    								}else{
						...
						if(columnIndexWithD_tFileInputDelimited_5 < rowtFileInputDelimited_5.length){
									...
									row5.SellStartDate = rowtFileInputDelimited_5[columnIndexWithD_tFileInputDelimited_5];
						...
						if(columnIndexWithD_tFileInputDelimited_5 < rowtFileInputDelimited_5.length){
									...
									row5.SellEndDate = rowtFileInputDelimited_5[columnIndexWithD_tFileInputDelimited_5];
						...
						if(columnIndexWithD_tFileInputDelimited_5 < rowtFileInputDelimited_5.length){
									...
									row5.DiscontinuedDate = rowtFileInputDelimited_5[columnIndexWithD_tFileInputDelimited_5];
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_6 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_6 = /** Start field tFileInputDelimited_6:FILENAME */"C:/Users/alons/Documents/MBA FIAP/DATAOPS/projeto_dataops/harmonized/FH_ProductCategory.csv"/** End field tFileInputDelimited_6:FILENAME */;		
	                ...
	                int columnIndexWithD_tFileInputDelimited_6 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_6 < rowtFileInputDelimited_6.length){
									...
									if(rowtFileInputDelimited_6[columnIndexWithD_tFileInputDelimited_6].length() > 0) {
										...
										row6.ProductCategoryID = ParserUtils.parseTo_Integer(rowtFileInputDelimited_6[columnIndexWithD_tFileInputDelimited_6]);
											...
											rowstate_tFileInputDelimited_6.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"ProductCategoryID", "row6", rowtFileInputDelimited_6[columnIndexWithD_tFileInputDelimited_6], ex_tFileInputDelimited_6), ex_tFileInputDelimited_6));
										}
    								}else{
						...
						if(columnIndexWithD_tFileInputDelimited_6 < rowtFileInputDelimited_6.length){
									...
									row6.ParentProductCategoryID = rowtFileInputDelimited_6[columnIndexWithD_tFileInputDelimited_6];
						...
						if(columnIndexWithD_tFileInputDelimited_6 < rowtFileInputDelimited_6.length){
									...
									row6.Name = rowtFileInputDelimited_6[columnIndexWithD_tFileInputDelimited_6];
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_7 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_7 = /** Start field tFileInputDelimited_7:FILENAME */"C:/Users/alons/Documents/MBA FIAP/DATAOPS/projeto_dataops/harmonized/FH_ProductModel.csv"/** End field tFileInputDelimited_7:FILENAME */;		
	                ...
	                int columnIndexWithD_tFileInputDelimited_7 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_7 < rowtFileInputDelimited_7.length){
									...
									if(rowtFileInputDelimited_7[columnIndexWithD_tFileInputDelimited_7].length() > 0) {
										...
										row7.ProductModelID = ParserUtils.parseTo_Integer(rowtFileInputDelimited_7[columnIndexWithD_tFileInputDelimited_7]);
											...
											rowstate_tFileInputDelimited_7.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"ProductModelID", "row7", rowtFileInputDelimited_7[columnIndexWithD_tFileInputDelimited_7], ex_tFileInputDelimited_7), ex_tFileInputDelimited_7));
										}
    								}else{
						...
						if(columnIndexWithD_tFileInputDelimited_7 < rowtFileInputDelimited_7.length){
									...
									row7.Name = rowtFileInputDelimited_7[columnIndexWithD_tFileInputDelimited_7];
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row8";
		...
		int tos_count_tAdvancedHash_row8 = 0;
			   		...
			   		// source node:tFileInputDelimited_8 - inputs:(after_tFileInputDelimited_1) outputs:(row8,row8) | target node:tAdvancedHash_row8 - inputs:(row8) outputs:()
			   		// linked node: tMap_1 - inputs:(row1,row2,row3,row4,row5,row6,row7,row8) outputs:(out1)
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_8 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_8 = /** Start field tFileInputDelimited_8:FILENAME */"C:/Users/alons/Documents/MBA FIAP/DATAOPS/projeto_dataops/harmonized/FH_Adress.csv"/** End field tFileInputDelimited_8:FILENAME */;		
	                ...
	                int columnIndexWithD_tFileInputDelimited_8 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_8 < rowtFileInputDelimited_8.length){
									...
									if(rowtFileInputDelimited_8[columnIndexWithD_tFileInputDelimited_8].length() > 0) {
										...
										row8.AddressID = ParserUtils.parseTo_Integer(rowtFileInputDelimited_8[columnIndexWithD_tFileInputDelimited_8]);
											...
											rowstate_tFileInputDelimited_8.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"AddressID", "row8", rowtFileInputDelimited_8[columnIndexWithD_tFileInputDelimited_8], ex_tFileInputDelimited_8), ex_tFileInputDelimited_8));
										}
    								}else{
						...
						if(columnIndexWithD_tFileInputDelimited_8 < rowtFileInputDelimited_8.length){
									...
									row8.AddressLine1 = rowtFileInputDelimited_8[columnIndexWithD_tFileInputDelimited_8];
						...
						if(columnIndexWithD_tFileInputDelimited_8 < rowtFileInputDelimited_8.length){
									...
									row8.AddressLine2 = rowtFileInputDelimited_8[columnIndexWithD_tFileInputDelimited_8];
						...
						if(columnIndexWithD_tFileInputDelimited_8 < rowtFileInputDelimited_8.length){
									...
									row8.City = rowtFileInputDelimited_8[columnIndexWithD_tFileInputDelimited_8];
						...
						if(columnIndexWithD_tFileInputDelimited_8 < rowtFileInputDelimited_8.length){
									...
									row8.StateProvince = rowtFileInputDelimited_8[columnIndexWithD_tFileInputDelimited_8];
						...
						if(columnIndexWithD_tFileInputDelimited_8 < rowtFileInputDelimited_8.length){
									...
									row8.CountryRegion = rowtFileInputDelimited_8[columnIndexWithD_tFileInputDelimited_8];
						...
						if(columnIndexWithD_tFileInputDelimited_8 < rowtFileInputDelimited_8.length){
									...
									row8.PostalCode = rowtFileInputDelimited_8[columnIndexWithD_tFileInputDelimited_8];
 ...
 */
    ...
    public static void main(String[] args){
        final dataset_modelo dataset_modeloClass = new dataset_modelo();

        int exitCode = dataset_modeloClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dataset_modelo.class.getClassLoader().getResourceAsStream("jobs_finalv2/dataset_modelo_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dataset_modelo.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dataset_modelo");
        }
...
/************************************************************************************************
 *     332854 characters generated by Talend Open Studio for Big Data 
 *     on the 2 de Maio de 2021 18h33min47s BRT
 ************************************************************************************************/